...
//   bool compareLength(const vector<string>& vec1, const vector<string>& vec2);
  ...
  // path.)
  void generatePermutations(vector<string>& locations, vector<string> temp, pair<double, vector<vector<string>>>& records);
  std::pair<double, std::vector<std::vector<std::string>>>
  TravelingTrojan_Brute_force(std::vector<std::string> location_ids);

  void generatePermutations_Backtracking(vector<string>& locations, vector<string> temp, pair<double, vector<vector<string>>>& records, double cur_dist);
  std::pair<double, std::vector<std::vector<std::string>>>
  ...
  void  generatePermutations_TrojanPath(vector<string>& locations, vector<string> temp, pair<double, vector<string>>& records, double dist);
